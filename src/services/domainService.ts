import { domainStore, type DomainTheme } from "@/stores/domains";
import { DEFAULT_DOMAINS } from "@/data/domainDefaults";

const STORAGE_KEY = "card-creator:domains";
...
function readStorage(): DomainTheme[] | null {
  ...
  try {
    ...
    return filterCustomDomains(parsed);
  } catch {
    return null;
  }
}
